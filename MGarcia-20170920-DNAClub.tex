...
\subtitle{Yes we can run it on Irma/Bianca with Singularity containers}
...
\begin{frame}{What is Singularity?}
	\vspace{-2cm}
	\center{\includegraphics[height=2cm]{pictures/singularity.png}}
	\begin{itemize}
...
\begin{frame}{We can do everything!}
	\center{\includegraphics[height=7.5cm]{pictures/Penguin-meme.jpg}}
\end{frame}

...
\titlegraphic{\vspace{1.9cm}
	\hfill\includegraphics[height=.7cm]{pictures/SciLifeLab}%

	\hfill\includegraphics[height=.7cm]{pictures/NGI}%

	\hfill\includegraphics[height=.7cm]{pictures/Barntumorbanken}%
}
